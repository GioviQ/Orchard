...
{
    [Admin]
    public class CustomAliasAdminController : Controller, IUpdateModel
    {
        public IOrchardServices Services { get; set; }
        private readonly ICustomAliasService _customAliasService;
        public CustomAliasAdminController(IOrchardServices services, ICustomAliasService customAliasService)
        {
            Services = services;
        ...
        [HttpPost, ActionName("Edit")]
        [Orchard.Mvc.FormValueRequired("submit.SaveAndEnable")]
